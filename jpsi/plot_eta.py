...
# Q2 bins matching J/psi phase space: q2min=0.001, q2max=0.25 GeV^2
Q2_bins = np.array([0.000, 0.020, 0.040, 0.060, 0.080, 0.100,
                    0.120, 0.140, 0.160, 0.180, 0.200, 0.220, 0.250])
...
ax.set_title(
    r'RC factor $J/\psi$ electroproduction, CLAS12 kinematics' + '\n' +
