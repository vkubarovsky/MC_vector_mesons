...
# Derive directory and RC filename from born filename
...
WORKDIR="$(pwd)"
mkdir -p "$LUND_DIR"
# Remove stale directory if a previous buggy run created LUND_BORN as a dir
...
# Collect and combine statistics from all finished job_* directories
python3 - << PYEOF
import glob, os, sys
